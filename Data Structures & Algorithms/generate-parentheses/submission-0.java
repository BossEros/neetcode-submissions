    ...
    public List<String> generateParenthesis(int n) {
        ...
        while(!stack.isEmpty()){
            ...
            if(currentState.open < n){
                stack.push(new State(currentState.current + "(", currentState.open + 1, currentState.close));
            }

            if(currentState.close < currentState.open){
                stack.push(new State(currentState.current + ")", currentState.open, currentState.close + 1));
            }
        }
        return result;
    }
